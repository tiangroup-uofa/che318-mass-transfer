...
submerged into a solution containing the same chemical with concentration $c_1$. The volume of liquid is so large that the concentration remains $c_1$ far away from the membrane-liquid interface.
