...
(Continue from Lecture 06) After this lecture, you will be able to:

- **Recall** how geometry changes the diffusion area and flux expression.
- **Describe** approximations used in spherical and non-uniform-area diffusion problems.
- **Identify** when the stagnant-B formulation applies to spherical evaporation problems.
- **Apply** pseudo-steady-state analysis to diffusion problems with changing diffusion paths.
- **Calculate** diffusivities from evaporation data in non-planar geometries.
...
its vapor pressure at 318 K is 0.555 mm Hg. The $D_{AB}$ of naphthalene in air at 318 K is $6.92\times{}10^{−6}\ \text{m}^2/\text{s}$.
