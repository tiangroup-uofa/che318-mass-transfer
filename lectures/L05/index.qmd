...
- Theories for predicting gas diffusivity $D_{AB}$:
  ...
  - Chapman-Enskog theory (high accuracy, hard to use)
...
- **Recall** key differences in diffusion behavior in gases, liquids, and solids.
- **Identify** limiting cases of mass transport in liquid systems.
- **Apply** EMCD, stagnant-B, and general-case flux equations for liquid transport.
- **Describe** gas-phase transport analogs in liquid and solid systems.
