...
transfer units", similar to the theoretical number of trays in a tray
...
In many industrial applications, engineers are interested in
one of the approaches to estimate the desired tower height:
...
absorb SO$_2$ from air using pure water at 293 K and 1 atm. The
