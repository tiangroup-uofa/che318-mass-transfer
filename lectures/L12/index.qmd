...
- **Recall** key ideas from steady-state and unsteady-state mass transfer.
- **Describe** representative midterm-style solution steps.
- **Identify** common conceptual pitfalls in mass transfer problems.
- **Relate** convective mass transfer ideas to earlier diffusion topics.
...
- Question types:
  - Multiple-choice questions (conceptual, no derivation)
...
## A mind map for mass transfer part I
