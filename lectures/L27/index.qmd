...
- **Recall** common measures used to express water content in air.
- **Describe** how humidity changes with temperature and saturation conditions.
- **Apply** equations for humid-air properties such as humid heat and enthalpy.
- **Explain** why humidification couples mass transfer with heat effects.
...
20% due to continuous heating. You and your roommate wish to purchase
a humidifier that can humidify the living room up to 45% relative
...
- Demystifying the humidification process: it's just mass transfer + heat transfer
