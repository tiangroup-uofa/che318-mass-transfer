...
- **Recall** major theories used to estimate molecular diffusivity.
- **Describe** how the diffusivity $D_{AB}$ changes with temperature and pressure.
- **Apply** tabulated reference data to estimate diffusivity values.
- **Formulate** governing equations for common diffusivity-measurement scenarios.
...
- Chapman-Enskog theory and Fuller method both have $D_{AB}\propto T^n/P$ form
- Fuller method is more often used as it can approximate $D_{AB}$ solely by taking values from tables
