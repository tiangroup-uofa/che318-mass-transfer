...
- Case 2: diffusion through stagnant B
  - $N_B = 0$
  - $N_A(1 - x_A) = -cD_{AB}\frac{d x_A}{dz}$
...
- $N_B = \lambda N_A$ ($\lambda$ is a constant. *why?*)
...
- Case 1: EMCD
  - $N_A + N_B = 0$
  $$
  N_A = \dfrac{D_{AB} c_T}{RT(z_2 - z_1)}(x_{A1} - x_{A2})
  $$
...
![](./images/geankoplis-gas-diff){width=700}
