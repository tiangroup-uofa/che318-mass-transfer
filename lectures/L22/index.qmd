...
- Recall the interface equilibrium conditions
- Describe the procedures to interpret the equilibrium diagram
- Derive steps to calculate interfacial concentration balances 
...
- Knowing $k_x'$ and $k_y'$ allows us to calculate the interfacial concentration $(x_Ai, y_Ai)$
