...
::: {.callout-note}
This lecture contains the overview of dimensionless number relation to mass transfer coefficients. Detailed discussions will be included in [Lecture 18](../L18), [Lecture 19](../L19), [Lecture 20](../L20) and [Lecture 21](../L21)
:::
...
5. Estimate effective area $A_{\text{eff}}$ inside the columne 👉  $\overline{N}_A = A_{\text{eff}} N_A$
...
- Use log-mean driving force (see [Lecture 21](../L21))

```{=tex}
\begin{align}
\overline{N}_A &= A_{\text{eff}} N_A \\
&= A_{\text{eff}} k_c \frac{
