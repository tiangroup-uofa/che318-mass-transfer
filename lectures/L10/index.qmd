...
$x_A{z, t}$ has an analytical solution with the given B.C.:
...
=1-(1-x_{A0})
\exp\!\left[
\ln\!\left(\frac{1-x_{A1}}{1-x_{A0}}\right)
\operatorname{erfc}\!\left(\frac{z}{\sqrt{4D_{AB}t}}\right)
\right]
\end{align}
```

$\operatorname{efrc}$ is the **complementary error function**:

```{=tex}
\begin{align}
\operatorname{erfc}(\eta)
&= 1 - \operatorname{erf}(\eta) \\
&= 
\frac{2}{\sqrt{\pi}}
\int_{0}^{\eta} e^{-s^2}\,ds
\end{align}
...
<iframe width="100%" height="800"
		src="../../scripts/L10_uss_evap.html" title="Webpage example"></iframe>
```
