...
- **Recall** the key components of the course syllabus, content, and grading scheme.
- **Identify** the main communication methods and learning resources available in the course.
- **Define** basic concepts in mass transfer, including concentration, mass fraction, and molar flux.
- **State** Fick's First Law of Diffusion and **identify** its terms and units.
- **Describe** the general shape of steady-state concentration profiles from Fick's Law.
...
- **Midterm Exam:** 30%
  ...
  - Time to be determined by end of January 2026

- **Final Exam:** 45%
  - In person
  - Scheduled **Apr 15, 2026 · 8:30 a.m.**

_Details please see the [course syllabus](../../syllabus/assets/CHE318-winter-2026-course-syllabus.pdf)_
...
- (Molar) Concentration of A: $c_{A}$
  - Unit: $\text{mol}\cdot\text{m}^{-3}$ or $\text{kg mol}\cdot\text{m}^{-3}$
  - Total concentration: $c_{T} = \sum_i c_{i} = c_A + c_B + \cdots$
  
- Molar fraction of A: $x_{A} = \dfrac{c_A}{c_T} = \dfrac{c_A}{c_A + c_B}$
  - For ideal gas: $x_A = \dfrac{p_A}{p_T}$ (partial pressure of A and total pressure, respectively)

- Molar ratio (for a binary mixture): $Y_A = \dfrac{x_A}{x_B} = \dfrac{x_A}{1 - x_A}$
  - Molar ratio $Y_A$ is less commonly used, unless for absorption tower in [Lecture 23](../L23)
    
	
## Basic quantities and their units in mass transfer (2)

- Mass concentration of A: $\rho_A$
