...
- **Recall** flux equations written with mass transfer coefficients in different phases.
- **Describe** why coefficient-based descriptions are useful for interfacial transport.
- **Identify** the units and meanings of common mass transfer coefficients.
- **Apply** conversions between coefficient forms used in gas- and liquid-phase analyses.
...
- Interfacial concentration profiles depend on equilibrium constraints and the relative resistance of each phase.
- Matching fluxes across the interface allows us to determine interfacial compositions.
- Mass transfer coefficients can be expressed in multiple forms, but their units and meanings must be tracked carefully.
