...
(Continue from Lecture 07) After this lecture, you will be able to:

- **Recall** the meaning of the pseudo-steady-state assumption in spherical coordinates.
- **Identify** differences between pseudo-steady-state and fully unsteady descriptions.
- **Describe** how changing path length affects time-dependent diffusion behavior.
